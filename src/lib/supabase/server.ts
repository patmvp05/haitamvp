 ...
 * a Client Component — the service_role key bypasses Row Level Security.
 * Guest-screen reads and authenticated staff-dashboard writes happen
 * server-side, so this is the only Supabase client the app needs.
 *
